        ...
        public partial class Inicio : Lui.Forms.AccountForm
        {
                ...
                public override Lfx.Types.OperationResult Edit(int lCodigo)
                {
                        if (m_Cliente == 0) {
                                ...
                                Lfx.Data.Row Movim = this.Workspace.DefaultDataBase.Row("ctacte", "id_movim", lCodigo);
                                if (Movim != null) {
                                        ...
                                        if (Movim["id_factura"] != null) {
                                                int IdFactura = System.Convert.ToInt32(Movim["id_factura"]);
                ...
                private void MostrarResumen()
                {
                        ...
                        if (m_Grupo != 0)
                                Where += " AND personas.id_grupo=" + m_Grupo.ToString();
                        m_SelectCommand.WhereClause = new Lfx.Data.SqlWhereBuilder(Where);
				...
				new Lfx.Data.FormField("saldo", "Saldo", Lfx.Data.InputFieldTypes.Currency, 160)
                        ...
                        foreach (System.Data.DataRow Cliente in Clientes.Rows) {
                                if (Cliente["saldo"] != DBNull.Value && System.Convert.ToDouble(Cliente["saldo"]) != 0) {
                                        ...
                                        Total += System.Convert.ToDouble(Cliente["saldo"]);
                                        itm.SubItems.Add(new ListViewItem.ListViewSubItem(itm, "-"));
                                        itm.SubItems.Add(new ListViewItem.ListViewSubItem(itm, "-"));
                                        itm.SubItems.Add(new ListViewItem.ListViewSubItem(itm, Lfx.Types.Formatting.FormatCurrency(System.Convert.ToDouble(Cliente["saldo"]), Workspace.CurrentConfig.Currency.DecimalPlaces)));
                                        itm.SubItems.Add(new ListViewItem.ListViewSubItem(itm, ""));
                                        itm.SubItems.Add(new ListViewItem.ListViewSubItem(itm, ""));
                                        itm.SubItems.Add(new ListViewItem.ListViewSubItem(itm, ""));
                                }
                        ...
                        m_FormFields = new Lfx.Data.FormField[]
			{
				...
				new Lfx.Data.FormField("ctacte.id_persona", "Persona", Lfx.Data.InputFieldTypes.Text, 160),
                        ...
                        TextoWhere += " AND ctacte.id_cliente=" + m_Cliente.ToString();
                        ...
                        System.Data.DataTable Registros = this.Workspace.DefaultDataBase.Select(this.SelectCommand());
                        ...
                        if (Registros.Rows.Count > 0) {
                                foreach (System.Data.DataRow Registro in Registros.Rows) {
                                        ...
                                        itm.SubItems.Add(new ListViewItem.ListViewSubItem(itm, Lfx.Types.Formatting.FormatDate(Registro["fecha"])));
                                        itm.SubItems.Add(new ListViewItem.ListViewSubItem(itm, System.Convert.ToString(Registro["concepto"])));
                                        if (System.Convert.ToDouble(Registro["importe"]) > 0) {
                                                dIngresos += System.Convert.ToDouble(Registro["importe"]);
                                                itm.SubItems.Add(new ListViewItem.ListViewSubItem(itm, "-"));
                                                itm.SubItems.Add(new ListViewItem.ListViewSubItem(itm, Lfx.Types.Formatting.FormatCurrency(System.Convert.ToDouble(Registro["importe"]), Workspace.CurrentConfig.Currency.DecimalPlaces)));
                                        } else {
                                        ...
                                        itm.SubItems.Add(new ListViewItem.ListViewSubItem(itm, Lfx.Types.Formatting.FormatCurrency(System.Convert.ToDouble(Registro["saldo"]), Workspace.CurrentConfig.Currency.DecimalPlaces)));
                                        itm.SubItems.Add(new ListViewItem.ListViewSubItem(itm, Lbl.Comprobantes.Comprobante.NumeroCompleto(this.Workspace.DefaultDataView, Lfx.Data.DataBase.ConvertDBNullToZero(Registro["id_factura"]))));
                                        itm.SubItems.Add(new ListViewItem.ListViewSubItem(itm, ""));
                                        itm.SubItems.Add(new ListViewItem.ListViewSubItem(itm, System.Convert.ToString(Registro["obs"])));
                                }
                                if (CurItem != null) {
                ...
                private void cmdNotaCred_Click(object sender, System.EventArgs e)
                {
                        if (m_Cliente > 0) {
                ...
                private void cmdNotaDeb_Click(object sender, System.EventArgs e)
                {
                        if (m_Cliente > 0) {
                ...
                private void FormCuentaCorriente_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
                {
                        switch (e.KeyCode) {
                                case Keys.F3:
                                        e.Handled = true;
                ...
                private void cmdAjuste_Click(object sender, System.EventArgs e)
                {
                        if (Lui.Login.LoginData.ValidateAccess(this.Workspace.CurrentUser, "ctacte.write")) {
                                ...
                                if (OAjuste.ShowDialog() == DialogResult.OK) {
                                        ...
                                        if (Importe == 0) {
                                                ...
                                                if (Cliente > 0) {
                                                        Lbl.Cuentas.CuentaCorriente CtaCte = new Lbl.Cuentas.CuentaCorriente(this.DataView, Cliente);
                ...
                private void FormCuentaCorriente_WorkspaceChanged(object sender, EventArgs e)
                {
