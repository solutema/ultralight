...
namespace Lfc.Cuentas
{
        public partial class IngresoEgreso : Lui.Forms.DialogForm
        {
                ...
                public int Cuenta
                {
                        get
                        {
                                return EntradaCuenta.TextInt;
                        }
                        set
                        {
                                m_Cuenta = value;
                                EntradaCuenta.TextInt = value;
                        }
                }
                ...
                public override Lfx.Types.OperationResult Ok()
                {
                        ...
                        if (aceptarReturn.Success == true) {
                                ...
                                if (m_Ingreso)
                                        Cuenta.Movimiento(false, EntradaConcepto.TextInt, EntradaConcepto.TextDetail, EntradaPersona.TextInt, Lfx.Types.Parsing.ParseCurrency(EntradaImporte.Text), EntradaObs.Text, 0, 0, EntradaComprobante.Text);
                                else
                                        Cuenta.Movimiento(false, EntradaConcepto.TextInt, EntradaConcepto.TextDetail, EntradaPersona.TextInt, -Lfx.Types.Parsing.ParseCurrency(EntradaImporte.Text), EntradaObs.Text, 0, 0, EntradaComprobante.Text);
                        }
