...
namespace Lfc.Cuentas.Conceptos
{
	public class Inicio : Lui.Forms.ListingForm
	{
			...
			: base()
		{
			...
			DataTableName = "cuentas_conceptos";
                        KeyField = new Lfx.Data.FormField("cuentas_conceptos.id_concepto", "Cód.", Lfx.Data.InputFieldTypes.Serial, 0);
			FormFields = new Lfx.Data.FormField[]
			{
				new Lfx.Data.FormField("cuentas_conceptos.nombre", "Nombre", Lfx.Data.InputFieldTypes.Text, 320),
				new Lfx.Data.FormField("cuentas_conceptos.es", "Tipo", Lfx.Data.InputFieldTypes.Text, 120),
				new Lfx.Data.FormField("cuentas_conceptos.grupo", "Grupo", Lfx.Data.InputFieldTypes.Text, 120)
			};
		}
		...
		private void InitializeComponent()
		{
			...
			// 
			// FormCuentasConceptosInicio
			// 
			this.AutoScaleBaseSize = new System.Drawing.Size(7, 16);
			this.ClientSize = new System.Drawing.Size(692, 473);
			this.Name = "FormCuentasConceptosInicio";
