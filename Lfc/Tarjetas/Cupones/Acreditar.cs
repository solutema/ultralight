...
namespace Lfc.Cupones.Cupones
{
        public partial class Acreditar : Lui.Forms.DialogForm
        {
                ...
                {
                        lblComisionTarjetaPct.Text = "(" + Lfx.Types.Formatting.FormatNumber(EntradaComisionTarjeta.Text.ParseCurrency() / EntradaSubTotal.Text.ParseCurrency() * 100, 2) + "%)";
                }

                private void EntradaComisionPlan_TextChanged(object sender, EventArgs e)
                {
                        lblComisionPlanPct.Text = "(" + Lfx.Types.Formatting.FormatNumber(EntradaComisionPlan.Text.ParseCurrency() / EntradaSubTotal.Text.ParseCurrency() * 100, 2) + "%)";
                }
