...
namespace Lfx.Access
{
        public class AccessList : System.Collections.Generic.List<Access>
        {
                ...
                public AccessList(Lfx.Workspace workspace)
                {
                ...
                private void Load()
                {
                        System.Data.DataTable AccList = this.Workspace.DefaultDataBase.Select("SELECT * FROM sys_accesslist WHERE id_persona=" + this.Workspace.CurrentUser.Id.ToString());
