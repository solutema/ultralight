...
namespace Lazaro.Impresion.Comprobantes.Fiscal
{
        public class Impresora
        {
                ...
                public Lazaro.Impresion.Comprobantes.Fiscal.Respuesta Cierre(string Tipo, bool Imprimir)
                {
                        ...
                        return new Lazaro.Impresion.Comprobantes.Fiscal.Respuesta(ErroresFiscales.Error);
                }
                ...
                private Lazaro.Impresion.Comprobantes.Fiscal.Respuesta Enviar(Comando comando)
                {
                        Lazaro.Impresion.Comprobantes.Fiscal.Respuesta Res = Inicializar();
                        ...
                        do {
                                ...
                                if (TengoETX) {
                                        ...
                                        Lazaro.Impresion.Comprobantes.Fiscal.Respuesta Respuesta = AnalizarRespuesta(CaracteresRecibidos);
                                        Log(Respuesta);
