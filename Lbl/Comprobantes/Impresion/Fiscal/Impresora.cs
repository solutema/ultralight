...
namespace Lbl.Comprobantes.Impresion.Fiscal
{
        ...
        {
                public Lbl.Comprobantes.Impresion.Fiscal.Modelos Modelo = Lbl.Comprobantes.Impresion.Fiscal.Modelos.Desconocido;
                private int m_PV = 0;
                ...
                public Impresora(Lfx.Workspace workspace)
                {
                        ...
                        this.DataBase = this.Workspace.GetDataBase("Impresora fiscal");
                ...
                public int PV
                {
                        ...
                        set
                        {
                                ...
                                if (this.m_PV > 0) {
                                        ...
                                        this.Modelo = (Lbl.Comprobantes.Impresion.Fiscal.Modelos)System.Convert.ToInt32(PVrow["modelo"]);
                ...
                public Lbl.Comprobantes.Impresion.Fiscal.Respuesta Inicializar()
                {
                        switch (Modelo) {
                                case Modelos.Emulacion:
                                ...
                                default:
                                        if (PuertoSerie.IsOpen == false) {
                                                ...
                                                if (Modelo != Modelos.HasarGenerico) {
                                                ...
                                                if (Modelo == Modelos.HasarGenerico) {
                                                        ...
                                                        Lbl.Comprobantes.Impresion.Fiscal.Respuesta Res = ObtenerEstadoImpresora();
                ...
                public Lbl.Comprobantes.Impresion.Fiscal.Respuesta Cierre(string Tipo, bool Imprimir)
                {
                        switch (Modelo) {
                                case Modelos.EpsonGenerico:
                                case Modelos.Emulacion:
                        ...
                        return new Lbl.Comprobantes.Impresion.Fiscal.Respuesta(ErroresFiscales.Error);
                }

                public Lbl.Comprobantes.Impresion.Fiscal.Respuesta CancelarDocumentoFiscal()
                {
                        switch (Modelo) {
                                case Modelos.EpsonGenerico:
                                case Modelos.Emulacion:
                        ...
                        return new Lbl.Comprobantes.Impresion.Fiscal.Respuesta();
                }

                public Lbl.Comprobantes.Impresion.Fiscal.Respuesta ImprimirComprobante(int idComprob)
                {
                        try {
                                ...
                                // No siempre puedo elevar mi propia prioridad
                        }

                        // *** Inicializar la impresora fiscal
                        Lbl.Comprobantes.Impresion.Fiscal.Respuesta Res = this.Inicializar();
                        ...
                        Comprobantes.Factura Fac = new Comprobantes.Factura(this.DataBase, idComprob);

                        if (Fac.Impreso)
                                return new Respuesta(ErroresFiscales.Ok);

                        // Asiento los precios de costo de los artículos de la factura (con fines estadsticos)
                        System.Data.DataTable ArticulosDetalle = this.DataBase.Select("SELECT comprob_detalle.id_comprob_detalle, comprob_detalle.id_articulo, articulos.costo FROM comprob_detalle, articulos WHERE comprob_detalle.id_articulo=articulos.id_articulo AND id_comprob=" + Fac.Id.ToString());
                        ...
                        foreach (Lbl.Comprobantes.DetalleArticulo Detalle in Fac.Articulos) {
                                ...
                                if (Detalle.Articulo != null) {
                                        if (StrCodigo == "id_articulo")
                                                ...
                                                StrCodigo = this.DataBase.FieldString("SELECT " + StrCodigo + " FROM articulos WHERE id_articulo=" + Detalle.Articulo.Id.ToString());
                                }
                ...
                private void SendToPrinter(byte[] command)
                {
                        ...
                        if (Modelo == Modelos.EpsonGenerico)
                ...
                private Lbl.Comprobantes.Impresion.Fiscal.Respuesta EnviarAEmulacion(Comando comando)
                {
                ...
                private Lbl.Comprobantes.Impresion.Fiscal.Respuesta Enviar(Comando comando)
                {
                        Lbl.Comprobantes.Impresion.Fiscal.Respuesta Res = Inicializar();
                        ...
                        do {
                                ...
                                if (TengoETX) {
                                        ...
                                        Lbl.Comprobantes.Impresion.Fiscal.Respuesta Respuesta = AnalizarRespuesta(CaracteresRecibidos);
                                        Log(Respuesta);
                ...
                protected Lbl.Comprobantes.Impresion.Fiscal.Respuesta AnalizarRespuesta(string respuesta)
                {
                        Lbl.Comprobantes.Impresion.Fiscal.Respuesta Res = new Lbl.Comprobantes.Impresion.Fiscal.Respuesta();
                                        ...
                                        case Modelos.HasarGenerico:
                                                ...
                                                switch (Modelo) {
                                                        ...
                                                        case Modelos.HasarGenerico:
                                                                ...
                                                                if (this.Modelo == Modelos.EpsonGenerico && Res.EstadoFiscal.HacerCierreZ) {
                ...
                public Lbl.Comprobantes.Impresion.Fiscal.Respuesta ObtenerEstadoImpresora()
                {
                        switch (Modelo) {
                                case Modelos.EpsonGenerico:
                                case Modelos.Emulacion:
