...
namespace Lbl.Comprobantes
{
        ...
        {
                //Heredar constructor
                public ReciboDeCobro(Lws.Data.DataView dataView)
                        : base(dataView)
                {
                        this.Crear();
                ...
                public ReciboDeCobro(Lws.Data.DataView dataView, Personas.Persona cliente)
                        : this(dataView)
                {
                        this.Crear();
                ...
                public ReciboDeCobro(Lws.Data.DataView dataView, int idRecibo)
                        : this(dataView)
                {
                ...
                public override Lfx.Types.OperationResult Crear()
                {
                        ...
                        this.Tipo = new Tipo(this.DataView, "RC");
                        return Res;
                }
        }
}